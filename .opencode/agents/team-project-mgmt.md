---
description: "📋 Project Management division coordinator — analyzes tasks and delegates to 7 specialists. — Invoke via @team-project-mgmt"
mode: primary
...
## All Project Management Agents (7 total)
